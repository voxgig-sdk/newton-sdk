...
|---|---|---|
| `ts/` | @voxgig-sdk/newton-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/newton-sdk \
      --repository voxgig-sdk/newton-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/newton-sdk` shows it, and
`npm trust revoke @voxgig-sdk/newton-sdk --id=<id>` removes it.
