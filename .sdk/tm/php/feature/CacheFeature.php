...
class NewtonCacheFeature extends NewtonBaseFeature
{
    ...
    private function _through(NewtonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
