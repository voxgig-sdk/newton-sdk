...
class NewtonNetsimFeature extends NewtonBaseFeature
{
    ...
    private function _simulate(NewtonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NewtonContext $ctx, array $applied): void
    {
        $client = $this->client;
