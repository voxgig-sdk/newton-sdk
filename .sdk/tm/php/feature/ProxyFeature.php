...
class NewtonProxyFeature extends NewtonBaseFeature
{
    ...
    public function init(NewtonContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NewtonContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
