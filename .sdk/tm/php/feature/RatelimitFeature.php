...
class NewtonRatelimitFeature extends NewtonBaseFeature
{
    ...
    private function _acquire(NewtonContext $ctx): void
    {
    ...
    private function _track(NewtonContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
