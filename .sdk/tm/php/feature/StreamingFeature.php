...
class NewtonStreamingFeature extends NewtonBaseFeature
{
    ...
    private function _iterate(NewtonResult $result): \Generator
    {
    ...
    private function _streamable(NewtonContext $ctx): bool
    {
