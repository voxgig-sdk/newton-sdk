...
// Newton SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NewtonTestFeature extends NewtonBaseFeature
{
    ...
    public function init(NewtonContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NewtonContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NewtonContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NewtonContext $ctx, $op, $args): array
    {
