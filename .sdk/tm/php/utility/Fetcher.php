...
class NewtonFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NewtonSDK/1.0)';
    ...
    public static function call(NewtonContext $ctx, string $fullurl, array $fetchdef): array
    {
