...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/newton` | `npm install @voxgig-sdk/newton` |
| Python | `voxgig-sdk-newton` | `pip install voxgig-sdk-newton` |
| PHP | `voxgig-sdk/newton` | `composer require voxgig-sdk/newton` |
| Golang | `github.com/voxgig-sdk/newton-sdk/go` | `go get github.com/voxgig-sdk/newton-sdk/go` |
| Ruby | `voxgig-sdk-newton` | `gem install voxgig-sdk-newton` |
| Lua | `voxgig-sdk-newton` | `luarocks install voxgig-sdk-newton` |
