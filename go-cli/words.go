...
func registerSDKWords(r *eng.Registry, client *sdk.NewtonSDK) {
...
func runOp(client *sdk.NewtonSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
