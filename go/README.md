...
## Install
```bash
go get github.com/voxgig-sdk/newton-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/newton-sdk=../path/to/github.com/voxgig-sdk/newton-sdk
```
...
```
github.com/voxgig-sdk/newton-sdk/
...
The root package (`github.com/voxgig-sdk/newton-sdk`) re-exports everything needed
