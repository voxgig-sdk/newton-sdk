...
func NewAbsEntity(client *core.NewtonSDK, entopts map[string]any) *AbsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AbsEntity) GetName() string { return e.name }
...
func (e *AbsEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AbsEntity) Deleted() bool {
	return e.deleted
}


func (e *AbsEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAbsEntity(e.client, opts)
}

func (e *AbsEntity) Data(args ...any) any {
...
func (e *AbsEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Abs; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AbsEntity) DataTyped(data ...Abs) Abs {
	if len(data) > 0 {
		return typedFrom[Abs](e.Data(asMap(data[0])))
	}
	return typedFrom[Abs](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Abs (all fields
// optional at the wire level).
func (e *AbsEntity) MatchTyped(match ...Abs) Abs {
	if len(match) > 0 {
		return typedFrom[Abs](e.Match(asMap(match[0])))
	}
	return typedFrom[Abs](e.Match())
}
...
func (e *AbsEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AbsEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AbsLoadMatch and returns an Abs. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AbsEntity) LoadTyped(reqmatch AbsLoadMatch, ctrl map[string]any) (Abs, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Abs{}, err
	}
	return typedFrom[Abs](res), nil
}



func (e *AbsEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AbsEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AbsEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AbsEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AbsEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
