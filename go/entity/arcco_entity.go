...
func NewArccoEntity(client *core.NewtonSDK, entopts map[string]any) *ArccoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArccoEntity) GetName() string { return e.name }
...
func (e *ArccoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArccoEntity) Deleted() bool {
	return e.deleted
}


func (e *ArccoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArccoEntity(e.client, opts)
}

func (e *ArccoEntity) Data(args ...any) any {
...
func (e *ArccoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ArccoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArccoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ArccoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArccoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArccoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArccoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
