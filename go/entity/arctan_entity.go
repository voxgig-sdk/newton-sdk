...
func NewArctanEntity(client *core.NewtonSDK, entopts map[string]any) *ArctanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArctanEntity) GetName() string { return e.name }
...
func (e *ArctanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArctanEntity) Deleted() bool {
	return e.deleted
}


func (e *ArctanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArctanEntity(e.client, opts)
}

func (e *ArctanEntity) Data(args ...any) any {
...
func (e *ArctanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Arctan; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArctanEntity) DataTyped(data ...Arctan) Arctan {
	if len(data) > 0 {
		return typedFrom[Arctan](e.Data(asMap(data[0])))
	}
	return typedFrom[Arctan](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Arctan (all fields
// optional at the wire level).
func (e *ArctanEntity) MatchTyped(match ...Arctan) Arctan {
	if len(match) > 0 {
		return typedFrom[Arctan](e.Match(asMap(match[0])))
	}
	return typedFrom[Arctan](e.Match())
}
...
func (e *ArctanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArctanEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArctanLoadMatch and returns an Arctan. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArctanEntity) LoadTyped(reqmatch ArctanLoadMatch, ctrl map[string]any) (Arctan, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Arctan{}, err
	}
	return typedFrom[Arctan](res), nil
}



func (e *ArctanEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ArctanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArctanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArctanEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArctanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
