...
func NewCosEntity(client *core.NewtonSDK, entopts map[string]any) *CosEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CosEntity) GetName() string { return e.name }
...
func (e *CosEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CosEntity) Deleted() bool {
	return e.deleted
}


func (e *CosEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCosEntity(e.client, opts)
}

func (e *CosEntity) Data(args ...any) any {
...
func (e *CosEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CosEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CosEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CosEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CosEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CosEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CosEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
