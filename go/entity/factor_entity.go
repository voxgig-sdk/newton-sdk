...
func NewFactorEntity(client *core.NewtonSDK, entopts map[string]any) *FactorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FactorEntity) GetName() string { return e.name }
...
func (e *FactorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FactorEntity) Deleted() bool {
	return e.deleted
}


func (e *FactorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFactorEntity(e.client, opts)
}

func (e *FactorEntity) Data(args ...any) any {
...
func (e *FactorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Factor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FactorEntity) DataTyped(data ...Factor) Factor {
	if len(data) > 0 {
		return typedFrom[Factor](e.Data(asMap(data[0])))
	}
	return typedFrom[Factor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Factor (all fields
// optional at the wire level).
func (e *FactorEntity) MatchTyped(match ...Factor) Factor {
	if len(match) > 0 {
		return typedFrom[Factor](e.Match(asMap(match[0])))
	}
	return typedFrom[Factor](e.Match())
}
...
func (e *FactorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FactorEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FactorLoadMatch and returns an Factor. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FactorEntity) LoadTyped(reqmatch FactorLoadMatch, ctrl map[string]any) (Factor, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Factor{}, err
	}
	return typedFrom[Factor](res), nil
}



func (e *FactorEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FactorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FactorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FactorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FactorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
