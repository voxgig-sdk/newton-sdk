...
func NewIntegrateEntity(client *core.NewtonSDK, entopts map[string]any) *IntegrateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IntegrateEntity) GetName() string { return e.name }
...
func (e *IntegrateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IntegrateEntity) Deleted() bool {
	return e.deleted
}


func (e *IntegrateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIntegrateEntity(e.client, opts)
}

func (e *IntegrateEntity) Data(args ...any) any {
...
func (e *IntegrateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Integrate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IntegrateEntity) DataTyped(data ...Integrate) Integrate {
	if len(data) > 0 {
		return typedFrom[Integrate](e.Data(asMap(data[0])))
	}
	return typedFrom[Integrate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Integrate (all fields
// optional at the wire level).
func (e *IntegrateEntity) MatchTyped(match ...Integrate) Integrate {
	if len(match) > 0 {
		return typedFrom[Integrate](e.Match(asMap(match[0])))
	}
	return typedFrom[Integrate](e.Match())
}
...
func (e *IntegrateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IntegrateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IntegrateLoadMatch and returns an Integrate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IntegrateEntity) LoadTyped(reqmatch IntegrateLoadMatch, ctrl map[string]any) (Integrate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Integrate{}, err
	}
	return typedFrom[Integrate](res), nil
}



func (e *IntegrateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IntegrateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IntegrateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IntegrateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IntegrateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
