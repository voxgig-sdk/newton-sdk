...
func NewLogEntity(client *core.NewtonSDK, entopts map[string]any) *LogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LogEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LogLoadMatch and returns an Log. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LogEntity) LoadTyped(reqmatch LogLoadMatch, ctrl map[string]any) (Log, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Log{}, err
	}
	return typedFrom[Log](res), nil
}



func (e *LogEntity) List(_ map[string]any, _ map[string]any) (any, error) {
