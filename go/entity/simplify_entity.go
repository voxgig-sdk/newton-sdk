...
func NewSimplifyEntity(client *core.NewtonSDK, entopts map[string]any) *SimplifyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SimplifyEntity) GetName() string { return e.name }
...
func (e *SimplifyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SimplifyEntity) Deleted() bool {
	return e.deleted
}


func (e *SimplifyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSimplifyEntity(e.client, opts)
}

func (e *SimplifyEntity) Data(args ...any) any {
...
func (e *SimplifyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Simplify; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SimplifyEntity) DataTyped(data ...Simplify) Simplify {
	if len(data) > 0 {
		return typedFrom[Simplify](e.Data(asMap(data[0])))
	}
	return typedFrom[Simplify](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Simplify (all fields
// optional at the wire level).
func (e *SimplifyEntity) MatchTyped(match ...Simplify) Simplify {
	if len(match) > 0 {
		return typedFrom[Simplify](e.Match(asMap(match[0])))
	}
	return typedFrom[Simplify](e.Match())
}
...
func (e *SimplifyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SimplifyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SimplifyLoadMatch and returns an Simplify. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SimplifyEntity) LoadTyped(reqmatch SimplifyLoadMatch, ctrl map[string]any) (Simplify, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Simplify{}, err
	}
	return typedFrom[Simplify](res), nil
}



func (e *SimplifyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SimplifyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SimplifyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SimplifyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SimplifyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
