...
func NewSinEntity(client *core.NewtonSDK, entopts map[string]any) *SinEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SinEntity) GetName() string { return e.name }
...
func (e *SinEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SinEntity) Deleted() bool {
	return e.deleted
}


func (e *SinEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSinEntity(e.client, opts)
}

func (e *SinEntity) Data(args ...any) any {
...
func (e *SinEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Sin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SinEntity) DataTyped(data ...Sin) Sin {
	if len(data) > 0 {
		return typedFrom[Sin](e.Data(asMap(data[0])))
	}
	return typedFrom[Sin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Sin (all fields
// optional at the wire level).
func (e *SinEntity) MatchTyped(match ...Sin) Sin {
	if len(match) > 0 {
		return typedFrom[Sin](e.Match(asMap(match[0])))
	}
	return typedFrom[Sin](e.Match())
}
...
func (e *SinEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SinEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SinLoadMatch and returns an Sin. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SinEntity) LoadTyped(reqmatch SinLoadMatch, ctrl map[string]any) (Sin, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Sin{}, err
	}
	return typedFrom[Sin](res), nil
}



func (e *SinEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SinEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SinEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SinEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SinEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
