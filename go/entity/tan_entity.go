...
func NewTanEntity(client *core.NewtonSDK, entopts map[string]any) *TanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TanEntity) GetName() string { return e.name }
...
func (e *TanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TanEntity) Deleted() bool {
	return e.deleted
}


func (e *TanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTanEntity(e.client, opts)
}

func (e *TanEntity) Data(args ...any) any {
...
func (e *TanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Tan; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TanEntity) DataTyped(data ...Tan) Tan {
	if len(data) > 0 {
		return typedFrom[Tan](e.Data(asMap(data[0])))
	}
	return typedFrom[Tan](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Tan (all fields
// optional at the wire level).
func (e *TanEntity) MatchTyped(match ...Tan) Tan {
	if len(match) > 0 {
		return typedFrom[Tan](e.Match(asMap(match[0])))
	}
	return typedFrom[Tan](e.Match())
}
...
func (e *TanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TanEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TanLoadMatch and returns an Tan. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TanEntity) LoadTyped(reqmatch TanLoadMatch, ctrl map[string]any) (Tan, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Tan{}, err
	}
	return typedFrom[Tan](res), nil
}



func (e *TanEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TanEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
