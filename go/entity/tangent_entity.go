...
func NewTangentEntity(client *core.NewtonSDK, entopts map[string]any) *TangentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TangentEntity) GetName() string { return e.name }
...
func (e *TangentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TangentEntity) Deleted() bool {
	return e.deleted
}


func (e *TangentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTangentEntity(e.client, opts)
}

func (e *TangentEntity) Data(args ...any) any {
...
func (e *TangentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Tangent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TangentEntity) DataTyped(data ...Tangent) Tangent {
	if len(data) > 0 {
		return typedFrom[Tangent](e.Data(asMap(data[0])))
	}
	return typedFrom[Tangent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Tangent (all fields
// optional at the wire level).
func (e *TangentEntity) MatchTyped(match ...Tangent) Tangent {
	if len(match) > 0 {
		return typedFrom[Tangent](e.Match(asMap(match[0])))
	}
	return typedFrom[Tangent](e.Match())
}
...
func (e *TangentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TangentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TangentLoadMatch and returns an Tangent. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TangentEntity) LoadTyped(reqmatch TangentLoadMatch, ctrl map[string]any) (Tangent, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Tangent{}, err
	}
	return typedFrom[Tangent](res), nil
}



func (e *TangentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TangentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TangentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TangentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TangentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
