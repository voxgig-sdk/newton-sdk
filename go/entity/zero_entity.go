...
func NewZeroEntity(client *core.NewtonSDK, entopts map[string]any) *ZeroEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ZeroEntity) GetName() string { return e.name }
...
func (e *ZeroEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ZeroEntity) Deleted() bool {
	return e.deleted
}


func (e *ZeroEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewZeroEntity(e.client, opts)
}

func (e *ZeroEntity) Data(args ...any) any {
...
func (e *ZeroEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Zero; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ZeroEntity) DataTyped(data ...Zero) Zero {
	if len(data) > 0 {
		return typedFrom[Zero](e.Data(asMap(data[0])))
	}
	return typedFrom[Zero](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Zero (all fields
// optional at the wire level).
func (e *ZeroEntity) MatchTyped(match ...Zero) Zero {
	if len(match) > 0 {
		return typedFrom[Zero](e.Match(asMap(match[0])))
	}
	return typedFrom[Zero](e.Match())
}
...
func (e *ZeroEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ZeroEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ZeroLoadMatch and returns an Zero. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ZeroEntity) LoadTyped(reqmatch ZeroLoadMatch, ctrl map[string]any) (Zero, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Zero{}, err
	}
	return typedFrom[Zero](res), nil
}



func (e *ZeroEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ZeroEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ZeroEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ZeroEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ZeroEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
