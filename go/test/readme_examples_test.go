...
const testSeed = `map[string]any{"entity": map[string]any{"abs": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "arcco": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "arcsin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "arctan": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "area": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cos": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "derive": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "factor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "integrate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "log": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "simplify": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tan": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tangent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "zero": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
