...
local ArcsinEntity = {}
ArcsinEntity.__index = ArcsinEntity


function ArcsinEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ArcsinEntity)
  self._name = "arcsin"
  self._client = client
...
function ArcsinEntity:get_name()
  return self._name
end


function ArcsinEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ArcsinEntity.new(self._client, opts)
end
...
function ArcsinEntity:mark_deleted()
  self._deleted = true
end


function ArcsinEntity:deleted()
  return true == self._deleted
end


function ArcsinEntity:data_set(args)
  if args ~= nil then
...
function ArcsinEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ArcsinEntity:match_set(args)
  if args ~= nil then
...
function ArcsinEntity:match_get()
...
function ArcsinEntity:stream(action, args, callopts)
...
---@param reqmatch ArcsinLoadMatch
---@param ctrl? table
---@return Arcsin
---@return string? err
function ArcsinEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ArcsinEntity:_run_op(ctx, post_done)
  local utility = self._utility
