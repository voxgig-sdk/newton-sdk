...
describe("AbsDirect", function()
  it("should direct-load-abs", function()
    local setup = abs_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-abs", setup.live and "live" or "unit")
...
function abs_direct_setup(mockres)
