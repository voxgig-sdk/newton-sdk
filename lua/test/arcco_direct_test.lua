...
describe("ArccoDirect", function()
  it("should direct-load-arcco", function()
    local setup = arcco_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-arcco", setup.live and "live" or "unit")
...
function arcco_direct_setup(mockres)
