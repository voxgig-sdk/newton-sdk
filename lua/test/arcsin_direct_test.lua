...
describe("ArcsinDirect", function()
  it("should direct-load-arcsin", function()
    local setup = arcsin_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-arcsin", setup.live and "live" or "unit")
...
function arcsin_direct_setup(mockres)
