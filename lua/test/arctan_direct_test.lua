...
describe("ArctanDirect", function()
  it("should direct-load-arctan", function()
    local setup = arctan_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-arctan", setup.live and "live" or "unit")
...
function arctan_direct_setup(mockres)
