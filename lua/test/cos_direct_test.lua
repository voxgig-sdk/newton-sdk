...
describe("CosDirect", function()
  it("should direct-load-cos", function()
    local setup = cos_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cos", setup.live and "live" or "unit")
...
function cos_direct_setup(mockres)
