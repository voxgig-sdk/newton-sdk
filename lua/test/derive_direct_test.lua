...
describe("DeriveDirect", function()
  it("should direct-load-derive", function()
    local setup = derive_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-derive", setup.live and "live" or "unit")
...
function derive_direct_setup(mockres)
