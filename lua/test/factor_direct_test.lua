...
describe("FactorDirect", function()
  it("should direct-load-factor", function()
    local setup = factor_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-factor", setup.live and "live" or "unit")
...
function factor_direct_setup(mockres)
