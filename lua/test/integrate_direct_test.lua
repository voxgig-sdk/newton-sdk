...
describe("IntegrateDirect", function()
  it("should direct-load-integrate", function()
    local setup = integrate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-integrate", setup.live and "live" or "unit")
...
function integrate_direct_setup(mockres)
