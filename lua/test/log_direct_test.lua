...
describe("LogDirect", function()
  it("should direct-load-log", function()
    local setup = log_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-log", setup.live and "live" or "unit")
