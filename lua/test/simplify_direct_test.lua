...
describe("SimplifyDirect", function()
  it("should direct-load-simplify", function()
    local setup = simplify_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-simplify", setup.live and "live" or "unit")
...
function simplify_direct_setup(mockres)
