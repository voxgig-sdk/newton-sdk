...
describe("SinDirect", function()
  it("should direct-load-sin", function()
    local setup = sin_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-sin", setup.live and "live" or "unit")
...
function sin_direct_setup(mockres)
