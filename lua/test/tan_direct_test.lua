...
describe("TanDirect", function()
  it("should direct-load-tan", function()
    local setup = tan_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tan", setup.live and "live" or "unit")
...
function tan_direct_setup(mockres)
