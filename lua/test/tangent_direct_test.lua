...
describe("TangentDirect", function()
  it("should direct-load-tangent", function()
    local setup = tangent_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tangent", setup.live and "live" or "unit")
...
function tangent_direct_setup(mockres)
