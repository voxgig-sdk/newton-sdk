...
describe("ZeroDirect", function()
  it("should direct-load-zero", function()
    local setup = zero_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-zero", setup.live and "live" or "unit")
...
function zero_direct_setup(mockres)
