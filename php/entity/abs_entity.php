...
class AbsEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AbsEntity($this->_client, $opts);
    }

    /**
     * @param Abs|array $args Abs data (assoc-array) to store.
     */
    ...
    /**
     * @return Abs|array The current Abs data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Abs fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Abs fields).
     */
     ...
     * Load a single Abs.
     *
     * @param AbsLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AbsLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Abs|array The loaded Abs as an assoc-array at the
