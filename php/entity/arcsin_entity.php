...
class ArcsinEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ArcsinEntity($this->_client, $opts);
    }

    /**
     * @param Arcsin|array $args Arcsin data (assoc-array) to store.
     */
    ...
    /**
     * @return Arcsin|array The current Arcsin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Arcsin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Arcsin fields).
     */
    ...
    /**
     * Load a single Arcsin.
     *
     * @param ArcsinLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ArcsinLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Arcsin|array The loaded Arcsin as an assoc-array at the
