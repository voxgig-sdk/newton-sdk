...
class ArctanEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ArctanEntity($this->_client, $opts);
    }

    /**
     * @param Arctan|array $args Arctan data (assoc-array) to store.
     */
    ...
    /**
     * @return Arctan|array The current Arctan data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Arctan fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Arctan fields).
     */
    ...
    /**
     * Load a single Arctan.
     *
     * @param ArctanLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ArctanLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Arctan|array The loaded Arctan as an assoc-array at the
