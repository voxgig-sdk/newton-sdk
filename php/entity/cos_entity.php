...
class CosEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CosEntity($this->_client, $opts);
    }

    /**
     * @param Cos|array $args Cos data (assoc-array) to store.
     */
    ...
    /**
     * @return Cos|array The current Cos data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cos fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cos fields).
     */
     ...
     * Load a single Cos.
     *
     * @param CosLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CosLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cos|array The loaded Cos as an assoc-array at the
