...
class DeriveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeriveEntity($this->_client, $opts);
    }

    /**
     * @param Derive|array $args Derive data (assoc-array) to store.
     */
    ...
    /**
     * @return Derive|array The current Derive data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Derive fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Derive fields).
     */
     ...
     *
     * @param DeriveLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DeriveLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Derive|array The loaded Derive as an assoc-array at the
