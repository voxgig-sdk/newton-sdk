...
class FactorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FactorEntity($this->_client, $opts);
    }

    /**
     * @param Factor|array $args Factor data (assoc-array) to store.
     */
    ...
    /**
     * @return Factor|array The current Factor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Factor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Factor fields).
     */
    ...
    /**
     * Load a single Factor.
     *
     * @param FactorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FactorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Factor|array The loaded Factor as an assoc-array at the
