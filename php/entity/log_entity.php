...
class LogEntity
{
     ...
     * Load a single Log.
     *
     * @param LogLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LogLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Log|array The loaded Log as an assoc-array at the
