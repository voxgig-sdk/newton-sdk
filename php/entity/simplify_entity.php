...
class SimplifyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SimplifyEntity($this->_client, $opts);
    }

    /**
     * @param Simplify|array $args Simplify data (assoc-array) to store.
     */
    ...
    /**
     * @return Simplify|array The current Simplify data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Simplify fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Simplify fields).
     */
     ...
     *
     * @param SimplifyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SimplifyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Simplify|array The loaded Simplify as an assoc-array at the
