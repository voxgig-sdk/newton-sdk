...
class SinEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SinEntity($this->_client, $opts);
    }

    /**
     * @param Sin|array $args Sin data (assoc-array) to store.
     */
    ...
    /**
     * @return Sin|array The current Sin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sin fields).
     */
     ...
     * Load a single Sin.
     *
     * @param SinLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SinLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sin|array The loaded Sin as an assoc-array at the
