...
class TanEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TanEntity($this->_client, $opts);
    }

    /**
     * @param Tan|array $args Tan data (assoc-array) to store.
     */
    ...
    /**
     * @return Tan|array The current Tan data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Tan fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Tan fields).
     */
     ...
     * Load a single Tan.
     *
     * @param TanLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TanLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tan|array The loaded Tan as an assoc-array at the
