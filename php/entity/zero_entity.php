...
class ZeroEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ZeroEntity($this->_client, $opts);
    }

    /**
     * @param Zero|array $args Zero data (assoc-array) to store.
     */
    ...
    /**
     * @return Zero|array The current Zero data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Zero fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Zero fields).
     */
     ...
     * Load a single Zero.
     *
     * @param ZeroLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ZeroLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Zero|array The loaded Zero as an assoc-array at the
