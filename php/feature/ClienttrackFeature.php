...
// Newton SDK clienttrack feature
...
class NewtonClienttrackFeature extends NewtonBaseFeature
{
    ...
    public function PostConstruct(NewtonContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Newton-SDK';
