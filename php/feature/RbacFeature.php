...
class NewtonRbacFeature extends NewtonBaseFeature
{
    ...
    private function _required(NewtonContext $ctx): ?string
    {
    ...
    private function _reject(NewtonContext $ctx, string $required): void
    {
    ...
    private function _track(NewtonContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
