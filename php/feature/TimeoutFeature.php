...
class NewtonTimeoutFeature extends NewtonBaseFeature
{
    ...
    private function _with_timeout(NewtonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NewtonContext $_ctx, float $ms): void
    {
        $client = $this->client;
