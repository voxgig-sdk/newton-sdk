...
class ArcsinDirectTest extends TestCase
{
    public function test_direct_load_arcsin(): void
    {
        $setup = arcsin_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-arcsin", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
