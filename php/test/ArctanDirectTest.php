...
class ArctanDirectTest extends TestCase
{
    public function test_direct_load_arctan(): void
    {
        $setup = arctan_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-arctan", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
