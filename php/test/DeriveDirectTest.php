...
class DeriveDirectTest extends TestCase
{
    public function test_direct_load_derive(): void
    {
        $setup = derive_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-derive", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
