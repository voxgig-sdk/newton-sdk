...
class LogEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set NEWTON_TEST_LOG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function log_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("NEWTON_TEST_LOG_ENTID");
