...
{
    private static function utility(): NewtonUtility
    {
        return new NewtonUtility();
    }
    ...
    private static function ctx(array $over = []): NewtonContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NewtonContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NewtonOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NewtonError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NewtonOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NewtonMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NewtonOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NewtonMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NewtonOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NewtonMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NewtonSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NewtonMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NewtonResponse([]),
            'result' => new NewtonResult([]),
        ]);
        [, $err] = NewtonMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NewtonSpec(['step' => 's']),
            'response' => new NewtonResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NewtonResult([]),
        ]);
        [, $err] = NewtonMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NewtonSpec(['step' => 's']),
            'response' => new NewtonResponse(self::resp(200, ['v' => 1])),
            'result' => new NewtonResult([]),
        ]);
        [, $err] = NewtonMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NewtonSpec(['step' => 's']),
            'response' => new NewtonResponse(self::resp(200, ['v' => 2])),
            'result' => new NewtonResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NewtonMakeResponse::call($ctx);
    ...
    {
        $preset = new NewtonResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NewtonSpec([]),
            'response' => new NewtonResponse([]),
            'result' => new NewtonResult([]),
        ...
        [$got, $err] = NewtonMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NewtonResult([])]);
        [, $err] = NewtonMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NewtonSpec([]), 'result' => null]);
        [, $err] = NewtonMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NewtonSpec(['step' => 's']),
            'result' => new NewtonResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NewtonOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NewtonMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NewtonSpec(['step' => 's']),
            'result' => new NewtonResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NewtonOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NewtonMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NewtonResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NewtonSpec([]),
            'result' => new NewtonResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NewtonMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NewtonMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NewtonError('boom', 'boom');
        $utility->fetcher = function (NewtonContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NewtonSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NewtonMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NewtonContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NewtonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NewtonResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NewtonContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NewtonSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NewtonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NewtonResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NewtonSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NewtonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NewtonMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NewtonMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NewtonResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NewtonDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NewtonResult(['ok' => false])]);
        $this->expectException(NewtonError::class);
        NewtonDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NewtonResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NewtonMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NewtonBaseFeature();
        $b = new NewtonBaseFeature();
        NewtonFeatureAdd::call($ctx, $a);
        NewtonFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NewtonBaseFeature
    {
        $f = new NewtonBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NewtonFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NewtonContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NewtonSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NewtonPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NewtonResponse(['headers' => null]),
            'result' => new NewtonResult([]),
        ]);
        NewtonResultHeaders::call($ctx);
