...
// Newton SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NewtonSDK::test)
...
{
    private const SDK_CLASS = 'NewtonSDK';
    ...
    private const SDK_BASE = 'newton_sdk';
