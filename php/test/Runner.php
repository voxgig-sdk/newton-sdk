...
class NewtonTestRunner
{
    ...
    {
        $live = self::getenv('NEWTON_TEST_LIVE');
        $override = self::getenv('NEWTON_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NEWTON_TEST_EXPLAIN');
...
class_alias('NewtonTestRunner', 'Runner');
class_alias('NewtonHelpers', 'Helpers');
