...
// Newton SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NewtonOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NewtonOmni::structfix($now, Struct::undef()))
                        !== json_encode(NewtonOmni::structfix($val, Struct::undef()))) {
