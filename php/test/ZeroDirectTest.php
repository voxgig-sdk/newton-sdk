...
class ZeroDirectTest extends TestCase
{
    public function test_direct_load_zero(): void
    {
        $setup = zero_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-zero", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
