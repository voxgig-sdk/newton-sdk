...
// Newton SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NewtonMakeRequest
{
    public static function call(NewtonContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NewtonResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NewtonResponse($fetched);
        } else {
