...
from newton_sdk.core.helpers import get_ctx_prop, to_map
...
class NewtonContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, NewtonResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NewtonError(code, msg, self)
