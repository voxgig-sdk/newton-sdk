# Newton SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NewtonSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NewtonSDK(...) and NewtonSDK.test(...) become
#      NewtonSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "newton_sdk"
_SDK_CLASS = "NewtonSDK"
