...
class AbsEntity
  ...
  # @return [Abs, Hash] the current Abs data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Abs fields)
  def match_get
  ...
  # Load a single Abs.
  #
  # @param reqmatch [AbsLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Abs.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Abs, Hash] the loaded Abs; raises NewtonError on failure
