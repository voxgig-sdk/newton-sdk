...
class ArccoEntity
  ...
  # @return [Arcco, Hash] the current Arcco data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Arcco fields)
  def match_get
  ...
  # Load a single Arcco.
  #
  # @param reqmatch [ArccoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Arcco.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Arcco, Hash] the loaded Arcco; raises NewtonError on failure
