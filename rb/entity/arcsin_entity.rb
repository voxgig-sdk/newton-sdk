...
class ArcsinEntity
  ...
  # @return [Arcsin, Hash] the current Arcsin data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Arcsin fields)
  def match_get
  ...
  #
  # @param reqmatch [ArcsinLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Arcsin.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Arcsin, Hash] the loaded Arcsin; raises NewtonError on failure
