...
class ArctanEntity
  ...
  # @return [Arctan, Hash] the current Arctan data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Arctan fields)
  def match_get
  ...
  #
  # @param reqmatch [ArctanLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Arctan.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Arctan, Hash] the loaded Arctan; raises NewtonError on failure
