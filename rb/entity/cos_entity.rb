...
class CosEntity
  ...
  # @return [Cos, Hash] the current Cos data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cos fields)
  def match_get
  ...
  # Load a single Cos.
  #
  # @param reqmatch [CosLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Cos.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cos, Hash] the loaded Cos; raises NewtonError on failure
