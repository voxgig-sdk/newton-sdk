...
class LogEntity
  ...
  # Load a single Log.
  #
  # @param reqmatch [LogLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Log.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Log, Hash] the loaded Log; raises NewtonError on failure
