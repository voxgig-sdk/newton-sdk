...
class SinEntity
  ...
  # @return [Sin, Hash] the current Sin data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Sin fields)
  def match_get
  ...
  # Load a single Sin.
  #
  # @param reqmatch [SinLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Sin.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Sin, Hash] the loaded Sin; raises NewtonError on failure
