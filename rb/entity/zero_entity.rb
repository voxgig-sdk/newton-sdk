...
class ZeroEntity
  ...
  # @return [Zero, Hash] the current Zero data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Zero fields)
  def match_get
  ...
  # Load a single Zero.
  #
  # @param reqmatch [ZeroLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Zero.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Zero, Hash] the loaded Zero; raises NewtonError on failure
