...
module NewtonTestRunner
  ...
  def self.env_override(m)
    live = getenv("NEWTON_TEST_LIVE")
    override = getenv("NEWTON_TEST_OVERRIDE")
    ...
    explain = getenv("NEWTON_TEST_EXPLAIN")
    m["NEWTON_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NewtonTestRunner
Helpers = NewtonHelpers
Vs = VoxgigStruct
