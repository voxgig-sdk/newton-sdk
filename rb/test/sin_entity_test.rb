...
class SinEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    sin_ref01_data_dt0_load_result = Helpers.to_map(sin_ref01_data_dt0_loaded.respond_to?(:data_get) ? sin_ref01_data_dt0_loaded.data_get : sin_ref01_data_dt0_loaded)
    assert !sin_ref01_data_dt0_load_result.nil?
    assert_equal sin_ref01_data_dt0_load_result["id"], sin_ref01_data["id"]
