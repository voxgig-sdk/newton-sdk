...
(0, node_test_1.describe)('ArccoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-arcco', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-arcco', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEWTON_TEST_ARCCO_ENTID'];
...
//# sourceMappingURL=ArccoDirect.test.js.map