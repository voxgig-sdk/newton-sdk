...
(0, node_test_1.describe)('CosEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'cos.' + op, live))
                return;
        }
        ...
        let cos_ref01_data = Object.values(setup.data.existing.cos)[0];
        // LOAD
        const cos_ref01_ent = client.Cos();
        const cos_ref01_match_dt0 = {};
        cos_ref01_match_dt0.id = cos_ref01_data.id;
        const cos_ref01_data_dt0 = (await cos_ref01_ent.load(cos_ref01_match_dt0)).data();
        (0, node_assert_1.default)(cos_ref01_data_dt0.id === cos_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cos/CosTestData.json');
    ...
    let idmap = transform(['cos01', 'cos02', 'cos03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['NEWTON_TEST_COS_ENTID'];
...
//# sourceMappingURL=CosEntity.test.js.map