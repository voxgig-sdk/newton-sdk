...
(0, node_test_1.describe)('IntegrateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-integrate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-integrate', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.NEWTON_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NewtonSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NEWTON_TEST_INTEGRATE_ENTID'];
    ...
    const client = new __1.NewtonSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IntegrateDirect.test.js.map