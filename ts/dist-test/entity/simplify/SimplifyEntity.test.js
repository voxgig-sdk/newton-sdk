...
(0, node_test_1.describe)('SimplifyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'simplify.' + op, live))
                return;
        }
        ...
        let simplify_ref01_data = Object.values(setup.data.existing.simplify)[0];
        // LOAD
        const simplify_ref01_ent = client.Simplify();
        const simplify_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(simplify_ref01_data_dt0.id === simplify_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/simplify/SimplifyTestData.json');
    ...
    let idmap = transform(['simplify01', 'simplify02', 'simplify03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['NEWTON_TEST_SIMPLIFY_ENTID'];
...
//# sourceMappingURL=SimplifyEntity.test.js.map