...
(0, node_test_1.describe)('SinDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-sin', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-sin', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEWTON_TEST_SIN_ENTID'];
...
//# sourceMappingURL=SinDirect.test.js.map