...
//     (\`new NewtonSDK(...)\` / \`NewtonSDK.test(...)\` become
//     \`NewtonSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"abs":{"test01":{"id":"test01"}},"arcco":{"test01":{"id":"test01"}},"arcsin":{"test01":{"id":"test01"}},"arctan":{"test01":{"id":"test01"}},"area":{"test01":{"id":"test01"}},"cos":{"test01":{"id":"test01"}},"derive":{"test01":{"id":"test01"}},"factor":{"test01":{"id":"test01"}},"integrate":{"test01":{"id":"test01"}},"log":{"test01":{"id":"test01"}},"simplify":{"test01":{"id":"test01"}},"sin":{"test01":{"id":"test01"}},"tan":{"test01":{"id":"test01"}},"tangent":{"test01":{"id":"test01"}},"zero":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new NewtonSDK(...)\` and any
// \`NewtonSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+NewtonSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/NewtonSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
